...
const float SHADOW_FAR_THRESH = 0.5;
...
// Samples the alpha component of a texture using a precomputed 4x4 bilinear
// kernel. Kernel weights are expected to add to 9.
